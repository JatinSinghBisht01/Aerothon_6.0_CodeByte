  ...
  return (
    ...
    <div className="flex min-h-full flex-col justify-center px-6 py-32 lg:px-28">
        <div className="sm:mx-auto sm:w-full sm:max-w-sm">
            ...
            <h2 className="mt-10 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900">Sign up to create new account</h2>
        </div>
  ...
  <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
    <form className="space-y-6">
      <div>
        ...
        <div>
        <CustomButton type={"submit"} text={"Sign up"} onSubmit={onSubmit} />
      </div>
    </form>
